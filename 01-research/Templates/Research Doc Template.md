...
1. For entity_type: use "research-document" for actual research docs
2. Keep 3-5 tags maximum for maintainability
3. Status indicators: ✅ Completed / ⚠️ Needs Review / 🔄 In Progress / ❌ Deprecated
4. Key Findings: Aim for 4 concise, numbered points
5. Next Actions: 4-5 specific, actionable tasks with checkboxes
6. Memory URLs: Use [[memory://path]] format for better connectivity
...
[Document content begins here - for research documents, this remains unmodified without Basic Memory connections]
